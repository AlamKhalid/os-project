...
void startFunction()
{
    ...
    GThread *startLoadingWindowThread, *startSetupThread;
    GError *err1 = NULL;
    GError *err2 = NULL;

    if ((startSetupThread = g_thread_create((GThreadFunc)setupThreadedFunction, NULL, TRUE, &err2)) == NULL)
    {
